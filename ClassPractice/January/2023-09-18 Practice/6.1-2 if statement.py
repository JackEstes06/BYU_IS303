# by combining comparisons with the if statement, you control what code gets executed

# Write a program that prints "congrats!" but only if num1 is not equal to num2
